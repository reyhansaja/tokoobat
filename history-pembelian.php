...
<body class="bg-primary">
    ...
    <div class="container mt-5 card">
        ...
        <div class="my-4"> 
            <a class="btn btn-primary" href="create-transaksi-pelanggan.php">Entri Transaksi</a><a style="margin-left: 10px;" class="btn btn-success" href="createpdf-pelanggann.php">Print</a>
        </div>
